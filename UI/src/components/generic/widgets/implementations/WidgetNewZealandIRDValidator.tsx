...
interface IWidgetNewZealandIRDValidatorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetNewZealandIRDValidator({ dashboardWidget }: IWidgetNewZealandIRDValidatorProps) {
...
export default WidgetNewZealandIRDValidator;