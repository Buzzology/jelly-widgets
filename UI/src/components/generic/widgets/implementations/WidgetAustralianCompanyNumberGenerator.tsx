...
interface IWidgetAustralianCompanyNumberGeneratorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetAustralianCompanyNumberGenerator({ dashboardWidget }: IWidgetAustralianCompanyNumberGeneratorProps) {
...
export default WidgetAustralianCompanyNumberGenerator;