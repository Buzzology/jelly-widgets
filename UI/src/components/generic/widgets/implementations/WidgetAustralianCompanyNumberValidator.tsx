...
interface IWidgetAustralianCompanyNumberValidatorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetAustralianCompanyNumberValidator({ dashboardWidget }: IWidgetAustralianCompanyNumberValidatorProps) {
...
export default WidgetAustralianCompanyNumberValidator;