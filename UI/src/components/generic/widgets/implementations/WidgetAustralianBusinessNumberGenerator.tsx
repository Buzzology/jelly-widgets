...
interface IWidgetAustralianBusinessNumberGeneratorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetAustralianBusinessNumberGenerator({ dashboardWidget }: IWidgetAustralianBusinessNumberGeneratorProps) {
...
export default WidgetAustralianBusinessNumberGenerator;