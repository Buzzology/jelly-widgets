...
interface IWidgetNewZealandIRDGeneratorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetNewZealandIRDGenerator({ dashboardWidget }: IWidgetNewZealandIRDGeneratorProps) {
...
export default WidgetNewZealandIRDGenerator;