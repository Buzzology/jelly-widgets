...
interface IWidgetAustralianMedicareNumberGeneratorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetAustralianMedicareNumberGenerator({ dashboardWidget }: IWidgetAustralianMedicareNumberGeneratorProps) {
    ...
    const onClickHandler = async () => {
        ...
        try {
            await dispatch(
                fetchDashboardWidgetProcessMessage({
...
export default WidgetAustralianMedicareNumberGenerator;