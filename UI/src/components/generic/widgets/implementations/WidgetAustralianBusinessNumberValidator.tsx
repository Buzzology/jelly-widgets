...
interface IWidgetAustralianBusinessNumberValidatorProps {
    dashboardWidget: IDashboardWidget,
}


function WidgetAustralianBusinessNumberValidator({ dashboardWidget }: IWidgetAustralianBusinessNumberValidatorProps) {
...
export default WidgetAustralianBusinessNumberValidator;